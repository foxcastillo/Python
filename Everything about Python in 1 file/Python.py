...
"""
Variables, used for temporary storage of data that may change
...
"""
Here are three different ways to store variables:
An integer, string, and float.
we use the 'type()' to see what type of data it is.
"""
print(type(age)) # int
...
"""
Variables are "dynamically typed"; Python checks the type of runtime.
"""
age = 26.2
print(type(age))
print(age, type(age)) # prints float and the prints data type class

"""
When naming variables it can have letters, numbers and underscore but
it cannot start with a digit and some python reserved words cannot be used
- use descriptive variable names (for others to understand your code)
- python is case sensitive
- constants must be in all caps. 
ex: PI = 3.14159
"""
print(id(age)) # prints the memory location of age using id()

"""
to swap variable values you must
"""
x = 5
y = 10
x, y = y, x
print('x =', x, 'y =', y) # basically a flip of x, y to y, x

"""
Boolean values; True or False
These all evaluate to False: 0, 0.0, [], "", None.
Any non-zero number, non-empty string, list, and/or set will result in True.
"""
# True statements
print(bool(1))
print(bool('dog'))
...
"""
Math Functions
built-in arithmethic functions are: add, subtract, multiply, 
divide, power, integer division, and modulus.
    + Addition
    - Subtraction
    * Multiplication
    / Division
...
"""
x += 5 is the same as saying as x = x + 5
"""
x = 2
x = x + 5
print(x)
...
"""
Console input
Gets the user input from the keyboard at the command prompt.
"""
"""
...
"""
Can have multiple conditions in a if, using and/or
"""
my_age = 19
grade = 'C'
...
"""
Strings
a string is a sequence of characters (ie. words/text)
"""
s = 'Howdy'
print(s)
print(len(s)) # 5
...
print(s[0:4].isalpha()) # True
print(s.isnumeric()) # False, not numeric
...
every statements indented from for will be executed each iteration
"""
s = 'Edgar'
for letter in s:
    print(letter)
...
# if inside a for loop, indentation is important
for pig in s:
    if pig != 'a':
        print(pig, end='')
print()
...
"""
Data Structures,
These functions all work on String, List, and Tuples
"""
...
x = ['pig', 'cow', 'horse']
print(x[1]) # prints second element: cow
...
# Adding / Concatenating == combine 2 sequences of the same tipe using +
x = 'horse' + 'shoe'
print(x) #horseshoe
